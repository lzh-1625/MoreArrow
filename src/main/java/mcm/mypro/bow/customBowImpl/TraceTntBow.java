...
import mcm.mypro.arrow.customArrowImpl.TraceArrowTnt;
...
public class TraceTntBow extends TraceBow implements CustomBow {
    ...
    public void shootArrow(Arrow arrow, Player player) {
        ...
        ArrowData.customArrowList.add(new TraceArrowTnt(arrow, Bukkit.getPlayer(targetName)));
    }
